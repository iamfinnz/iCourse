package com.example.icourse.presentation.content
...
import com.example.icourse.adapter.PagesAdapter
import com.example.icourse.databinding.ActivityContentBinding
...
import com.example.icourse.repository.Repository
        ...
        contentBinding.vpContent.addOnPageChangeListener(object : ViewPager.OnPageChangeListener{
            override fun onPageScrolled(
                ...
                if (currentPosition == 0){
                    ...
                    contentBinding.btnPrevContent.disable()
                } else {
