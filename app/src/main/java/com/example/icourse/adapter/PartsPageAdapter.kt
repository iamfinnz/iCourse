...
import com.example.icourse.databinding.LayoutMarkdownBinding
import com.example.icourse.databinding.LayoutYoutubeBinding
...
class PartsPageAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    class YouTubeViewHolder(private val youtubeBinding: LayoutYoutubeBinding)
        ...
        fun bindItem(partPage: PartsPage) {
            youtubeBinding.yvContent.addYouTubePlayerListener(object : AbstractYouTubePlayerListener(){
